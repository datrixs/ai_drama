        ...
        <div class="edit-content">
          <div class="edit-form">
            <label class="edit-field">
              ...
              <input v-model="form.name" class="glass-input-base" placeholder="角色名称" maxlength="256" />
            </label>
            <label class="edit-field">
              <span class="field-label">别名</span>
              <input v-model="form.aliases" class="glass-input-base" placeholder="角色别名" />
            </label>
            <label class="edit-field">
              <span class="field-label">描述</span>
              <textarea v-model="form.description" class="glass-textarea-base" rows="10" placeholder="角色描述" />
            </label>
            <label class="edit-field">
          ...
          <div class="edit-preview">
            ...
            <div class="preview-image-container">
              <img v-if="character?.image_url" :src="character.image_url" alt="" class="preview-image" />
