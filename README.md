...
[快速开始](#-快速开始) · [功能特性](#-功能特性) · [使用截图](#-使用截图) · [配置说明](#%EF%B8%8F-配置说明) · [微信交流群](#-微信交流群) · [参与贡献](#-参与贡献)
...
欢迎加入微信交流群，与开发者及社区用户交流使用经验与短剧制作技巧：
...
> 若二维码已过期，请通过 [GitHub Issues](https://github.com/datrixs/ai_drama/issues) 联系我们获取最新入群方式
