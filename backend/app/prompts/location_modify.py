TEMPLATE_ZH = """请按照以下提示词规则执行用户的修改场景需求
...
TEMPLATE_EN = """You are a professional scene prompt modifier.
...
def build_prompt(location_name: str, location_input: str, user_input: str, locale: str = "zh") -> str:
